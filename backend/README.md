...
## Project Structure
    ...
    ├── testapiautodatamod_118964  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_118964`
...
2. Clone this repo and `cd testapiautodatamod_118964`
